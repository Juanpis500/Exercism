...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    percent_normal = threshold * 0.10
    temp_neutron = temperature * neutrons_produced_per_second
    
    if temp_neutron < threshold * 0.90:
        return 'LOW'
    elif temp_neutron > threshold - percent_normal and temp_neutron < threshold + percent_normal:
        return 'NORMAL'
    else:
        return 'DANGER'
