...
def approx_average_is_average(hand):
    ...
    return ((hand[0] + hand[-1])/2) == card_average(hand) or card_average(hand) == hand[int((len(hand)/2)+0.5)-1]
...
def average_even_is_average_odd(hand):
    ...
    """
    number_odd = hand[0::2]
    number_even = hand[1::2]
    
    return sum(number_even)/len(number_even) == sum(number_odd)/len(number_odd)
